        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" class="d-flex flex-column gap-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div>
                                ...
                                <textarea name="answer" rows="6" class="form-control">{{ old('answer', $faq->answer) }}</textarea>
                                @error('answer')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
